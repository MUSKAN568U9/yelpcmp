...
const sessionConfig = {
  ...
  store: new pgSession({
    conString: `postgres://${dbUser}:${dbPass}@dpg-cos0pqvsc6pc73dv3etg-a.oregon-postgres.render.com/yelpcamp_rq7f?ssl=true`, // Replace with your PostgreSQL connection string
    tableName: 'session',
    ssl: {
